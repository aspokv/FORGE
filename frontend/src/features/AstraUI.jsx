...
const paths={home:'M3 10 12 3 21 10M5 9v12h5v-7h4v7h5V9',training:'M3 9v6M6.5 6.5v11M6.5 12h11M17.5 6.5v11M21 9v6',nutrition:'M5 3v7m3-7v7M3 3v6q0 3 4 3v9m11-18q-5 4-4 10h4m0-10v18',progress:'M4 3v17h17M7 15l4-5 4 2 5-7',profile:'M8 7a4 4 0 1 0 8 0 4 4 0 1 0-8 0M4 21v-2a8 8 0 0 1 16 0v2',chevron:'m9 5 7 7-7 7',arrow:'M4 12h15M13 6l6 6-6 6',clock:'M12 7v5l3 2M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18',water:'M12 2s-7 9-7 13a7 7 0 0 0 14 0C19 11 12 2 12 2M8 15a4 4 0 0 0 4 4',check:'m5 12 4 4L19 6',book:'M12 5v16M3 4h5q4 0 4 2 0-2 4-2h5v15h-5q-4 0-4 2 0-2-4-2H3Z',settings:'M4 5h16M4 12h16M4 19h16M8 3v4M16 10v4M10 17v4',camera:'M3 7h4l2-3h6l2 3h4v14H3ZM12 10a4 4 0 1 0 0 8 4 4 0 1 0 0-8',shield:'m12 3 8 3v6c0 5-8 9-8 9s-8-4-8-9V6Z M8 12l3 3 5-6'};
...
export function AstraAction({children,onClick,testId,disabled}) {return <button type="button" className="a6-primary" data-testid={testId} disabled={disabled} onClick={onClick}>{children}<AstraIcon name="arrow"/></button>}
