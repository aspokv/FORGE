...
export function AstraPage({screen,children,onLibrary,testId}) {
  ...
  return <div className={`a6 a6-screen-${screen}`} data-testid={testId}>
    <header className="a6-app-header"><div className="a6-logo" role="img" aria-label="FORGE, marca original com chama"><img src={brand} alt=""/></div><button type="button" className="a6-iconbutton" aria-label={onLibrary?"Abrir biblioteca de treinos":"Abrir perfil"} onClick={onLibrary||nav.profile}><AstraIcon name={onLibrary?"book":"profile"}/></button></header>
