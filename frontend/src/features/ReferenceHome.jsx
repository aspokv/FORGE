...
import planLegsArt from "../assets/forge-plan-legs-reference.jpg";
...
export const planArtworkFor=(sessionName,focus=[])=>{const kind=planArtworkKindFor(sessionName,focus);return kind==="pull"?planPullArt:kind==="legs"?planLegsArt:kind==="push"?"/images/anatomy/push-front.webp":fallbackArt};
