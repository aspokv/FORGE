...
export default function ReferenceHome({db,start,onRecoveryCheckin}){
  ...
  return <AstraPage screen={0} testId="reference-home-v3">
    <AstraIntro eyebrow={dateLabel} title={`Olá, ${displayName}.`} subtitle={todayCompletion?"Sessão concluída. Recuperação também faz parte do progresso.":restDay?"Hoje é descanso no seu programa.":"Seu próximo passo está aqui."}/>
