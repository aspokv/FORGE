...
function Progress({analytics,profileId,exercises,program}){return <AstraProgress API={API} profileId={profileId} exercises={exercises} program={program} analytics={analytics} weightPanel={<WeightTracker profileId={profileId}/>} photosPanel={<ProgressPhotos API={API} profileId={profileId}/>} details={<ProgressDetails analytics={analytics} profileId={profileId}/>}/>}
