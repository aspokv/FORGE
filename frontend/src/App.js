...
function Workout({db,techniques,openTech,goHome,onExerciseSubstituted,onWorkoutCompleted,onLibraryBuild,onLibraryTemplateAdd}){
  ...
  if(view==="library")return <div className="training-library-view"data-testid="training-library-view">
    ...
    <WorkoutLibrary API={API}exercises={db.exercises||[]}profile={db.profile}program={db.program}onBuild={onLibraryBuild}onTemplateAdd={onLibraryTemplateAdd}onApplied={()=>setView("session")}/>
  </div>;
